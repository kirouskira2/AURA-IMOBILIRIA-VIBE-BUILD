...
export function StatsSection() {
  return (
    <div className="relative z-20 -mt-16 md:-mt-32 flex flex-col md:flex-row items-center justify-center gap-12 md:gap-24 py-16 animate-fade-in opacity-0 translate-y-[-1rem] [--animation-delay:800ms] border-b border-black/5 bg-gradient-to-b from-transparent to-black/[0.02]">
